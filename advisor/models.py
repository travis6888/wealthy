...
class PersonalPortfolio(models.Model):
    ...
    stock_one_shares = models.DecimalField(max_digits=100, decimal_places=3, blank=True, null=True, default=0)
    stock_two_name = models.CharField(max_length=6, blank=True, null=True)
    stock_two_shares = models.DecimalField(max_digits=100, decimal_places=3, blank=True, null=True, default=0)
    stock_three_name = models.CharField(max_length=6, blank=True, null=True)
    stock_three_shares = models.DecimalField(max_digits=100, decimal_places=3, blank=True, null=True, default=0)
    stock_four_name = models.CharField(max_length=6, blank=True, null=True)
    stock_four_shares = models.DecimalField(max_digits=100, decimal_places=3, blank=True, null=True, default=0)
    stock_five_name = models.CharField(max_length=6, blank=True, null=True)
    stock_five_shares = models.DecimalField(max_digits=100, decimal_places=3, blank=True, null=True, default=0)
