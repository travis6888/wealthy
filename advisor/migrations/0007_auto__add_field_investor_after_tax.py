...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investor.after_tax'
        db.add_column(u'advisor_investor', 'after_tax',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investor.after_tax'
        db.delete_column(u'advisor_investor', 'after_tax')
