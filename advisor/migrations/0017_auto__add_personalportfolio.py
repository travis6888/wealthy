...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'advisor_personalportfolio', (
            ...
            ('cost', self.gf('django.db.models.fields.FloatField')(max_length=90)),
            ('stock_one_shares', self.gf('django.db.models.fields.FloatField')(max_length=100)),
            ('stock_two_shares', self.gf('django.db.models.fields.FloatField')(max_length=100)),
            ('stock_three_shares', self.gf('django.db.models.fields.FloatField')(max_length=100)),
            ('stock_four_shares', self.gf('django.db.models.fields.FloatField')(max_length=100)),
            ('stock_five_shares', self.gf('django.db.models.fields.FloatField')(max_length=100)),
        ))
    ...
    models = {
        ...
        u'advisor.personalportfolio': {
            ...
            'cost': ('django.db.models.fields.FloatField', [], {'max_length': '90'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'personal_portfolio'", 'to': u"orm['advisor.Investor']"}),
            'stock_five_shares': ('django.db.models.fields.FloatField', [], {'max_length': '100'}),
            'stock_four_shares': ('django.db.models.fields.FloatField', [], {'max_length': '100'}),
            'stock_one_shares': ('django.db.models.fields.FloatField', [], {'max_length': '100'}),
            'stock_three_shares': ('django.db.models.fields.FloatField', [], {'max_length': '100'}),
            'stock_two_shares': ('django.db.models.fields.FloatField', [], {'max_length': '100'})
        },
        u'advisor.portfolio': {
