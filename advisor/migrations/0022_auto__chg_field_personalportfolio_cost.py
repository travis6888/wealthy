...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'advisor_personalportfolio', 'cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=100, decimal_places=3))
    ...
    models = {
        ...
        u'advisor.personalportfolio': {
            ...
            'cost': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '100', 'decimal_places': '3', 'blank': 'True'}),
