...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investment.hidden_symbol'
        db.add_column(u'advisor_investment', 'hidden_symbol',
                      self.gf('django.db.models.fields.TextField')(max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investment.hidden_symbol'
        db.delete_column(u'advisor_investment', 'hidden_symbol')
