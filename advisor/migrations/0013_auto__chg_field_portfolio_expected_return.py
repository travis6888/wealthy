...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Portfolio.expected_return'
        db.alter_column(u'advisor_portfolio', 'expected_return', self.gf('django.db.models.fields.FloatField')(max_length=5, null=True))

    def backwards(self, orm):

        # Changing field 'Portfolio.expected_return'
        db.alter_column(u'advisor_portfolio', 'expected_return', self.gf('django.db.models.fields.FloatField')(max_length=5))
