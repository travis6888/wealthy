...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investor.disposible_monthly'
        db.add_column(u'advisor_investor', 'disposible_monthly',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investor.disposible_monthly'
        db.delete_column(u'advisor_investor', 'disposible_monthly')
