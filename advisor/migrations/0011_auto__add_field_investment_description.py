...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investment.description'
        db.add_column(u'advisor_investment', 'description',
                      self.gf('django.db.models.fields.TextField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investment.description'
        db.delete_column(u'advisor_investment', 'description')
