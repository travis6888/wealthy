...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investor.expected_return'
        db.add_column(u'advisor_investor', 'expected_return',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=120),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investor.expected_return'
        db.delete_column(u'advisor_investor', 'expected_return')
    ...
    models = {
        ...
        u'advisor.investor': {
            ...
            'expected_return': ('django.db.models.fields.FloatField', [], {'default': '0', 'max_length': '120'}),
