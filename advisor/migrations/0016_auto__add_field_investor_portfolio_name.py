...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investor.portfolio_name'
        db.add_column(u'advisor_investor', 'portfolio_name',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investor.portfolio_name'
        db.delete_column(u'advisor_investor', 'portfolio_name')
