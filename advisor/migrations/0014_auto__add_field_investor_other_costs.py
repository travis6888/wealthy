...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investor.other_costs'
        db.add_column(u'advisor_investor', 'other_costs',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investor.other_costs'
        db.delete_column(u'advisor_investor', 'other_costs')
