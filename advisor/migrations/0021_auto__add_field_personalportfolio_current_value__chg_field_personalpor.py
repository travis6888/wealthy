...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalPortfolio.current_value'
        db.add_column(u'advisor_personalportfolio', 'current_value',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=100, decimal_places=3, blank=True),
                      keep_default=False)


        # Changing field 'PersonalPortfolio.stock_one_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_one_shares', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=3))

        # Changing field 'PersonalPortfolio.stock_three_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_three_shares', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=3))

        # Changing field 'PersonalPortfolio.stock_four_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_four_shares', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=3))

        # Changing field 'PersonalPortfolio.cost'
        db.alter_column(u'advisor_personalportfolio', 'cost', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=3))

        # Changing field 'PersonalPortfolio.stock_two_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_two_shares', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=3))

        # Changing field 'PersonalPortfolio.stock_five_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_five_shares', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=3))

    def backwards(self, orm):
        # Deleting field 'PersonalPortfolio.current_value'
        db.delete_column(u'advisor_personalportfolio', 'current_value')


        # Changing field 'PersonalPortfolio.stock_one_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_one_shares', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=100, decimal_places=3))
    ...
    models = {
        ...
        u'advisor.personalportfolio': {
            ...
            'cost': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '100', 'decimal_places': '3', 'blank': 'True'}),
            'current_value': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '100', 'decimal_places': '3', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'stock_five_shares': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '100', 'decimal_places': '3', 'blank': 'True'}),
            'stock_four_name': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'stock_four_shares': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '100', 'decimal_places': '3', 'blank': 'True'}),
            'stock_one_name': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'stock_one_shares': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '100', 'decimal_places': '3', 'blank': 'True'}),
            'stock_three_name': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'stock_three_shares': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '100', 'decimal_places': '3', 'blank': 'True'}),
            'stock_two_name': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'stock_two_shares': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '100', 'decimal_places': '3', 'blank': 'True'})
        },
        u'advisor.portfolio': {
