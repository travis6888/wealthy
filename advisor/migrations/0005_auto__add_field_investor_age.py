...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investor.age'
        db.add_column(u'advisor_investor', 'age',
                      self.gf('django.db.models.fields.IntegerField')(default=18, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investor.age'
        db.delete_column(u'advisor_investor', 'age')
