...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Investment.fees'
        db.alter_column(u'advisor_investment', 'fees', self.gf('django.db.models.fields.FloatField')(max_length=5))
        # Adding field 'Portfolio.expected_return'
        db.add_column(u'advisor_portfolio', 'expected_return',
                      self.gf('django.db.models.fields.FloatField')(default=0, max_length=5),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Investment.fees'
        db.alter_column(u'advisor_investment', 'fees', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=10))
        # Deleting field 'Portfolio.expected_return'
        db.delete_column(u'advisor_portfolio', 'expected_return')
    ...
    models = {
        ...
        u'advisor.investor': {
            ...
            'after_tax': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
