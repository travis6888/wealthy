...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalPortfolio.stock_one_name'
        db.add_column(u'advisor_personalportfolio', 'stock_one_name',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonalPortfolio.stock_two_name'
        db.add_column(u'advisor_personalportfolio', 'stock_two_name',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonalPortfolio.stock_three_name'
        db.add_column(u'advisor_personalportfolio', 'stock_three_name',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonalPortfolio.stock_four_name'
        db.add_column(u'advisor_personalportfolio', 'stock_four_name',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonalPortfolio.stock_five_name'
        db.add_column(u'advisor_personalportfolio', 'stock_five_name',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True),
                      keep_default=False)


        # Changing field 'PersonalPortfolio.stock_one_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_one_shares', self.gf('django.db.models.fields.FloatField')(max_length=100, null=True))

        # Changing field 'PersonalPortfolio.name'
        db.alter_column(u'advisor_personalportfolio', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
        ...
        # Changing field 'PersonalPortfolio.cost'
        db.alter_column(u'advisor_personalportfolio', 'cost', self.gf('django.db.models.fields.FloatField')(max_length=90, null=True))
    ...
    def backwards(self, orm):
        # Deleting field 'PersonalPortfolio.stock_one_name'
        db.delete_column(u'advisor_personalportfolio', 'stock_one_name')

        # Deleting field 'PersonalPortfolio.stock_two_name'
        db.delete_column(u'advisor_personalportfolio', 'stock_two_name')

        # Deleting field 'PersonalPortfolio.stock_three_name'
        db.delete_column(u'advisor_personalportfolio', 'stock_three_name')

        # Deleting field 'PersonalPortfolio.stock_four_name'
        db.delete_column(u'advisor_personalportfolio', 'stock_four_name')

        # Deleting field 'PersonalPortfolio.stock_five_name'
        db.delete_column(u'advisor_personalportfolio', 'stock_five_name')


        # Changing field 'PersonalPortfolio.stock_one_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_one_shares', self.gf('django.db.models.fields.FloatField')(default=None, max_length=100))

        # Changing field 'PersonalPortfolio.name'
        db.alter_column(u'advisor_personalportfolio', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))

        # Changing field 'PersonalPortfolio.stock_three_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_three_shares', self.gf('django.db.models.fields.FloatField')(default=None, max_length=100))

        # Changing field 'PersonalPortfolio.stock_four_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_four_shares', self.gf('django.db.models.fields.FloatField')(default=None, max_length=100))

        # Changing field 'PersonalPortfolio.cost'
        db.alter_column(u'advisor_personalportfolio', 'cost', self.gf('django.db.models.fields.FloatField')(default=None, max_length=90))

        # Changing field 'PersonalPortfolio.stock_two_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_two_shares', self.gf('django.db.models.fields.FloatField')(default=None, max_length=100))

        # Changing field 'PersonalPortfolio.stock_five_shares'
        db.alter_column(u'advisor_personalportfolio', 'stock_five_shares', self.gf('django.db.models.fields.FloatField')(default=None, max_length=100))
    ...
    models = {
        ...
        u'advisor.personalportfolio': {
            ...
            'stock_five_shares': ('django.db.models.fields.FloatField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'stock_four_name': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'stock_four_shares': ('django.db.models.fields.FloatField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'stock_one_name': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'stock_one_shares': ('django.db.models.fields.FloatField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'stock_three_name': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'stock_three_shares': ('django.db.models.fields.FloatField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'stock_two_name': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'stock_two_shares': ('django.db.models.fields.FloatField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        u'advisor.portfolio': {
